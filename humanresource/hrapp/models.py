...
class Vacany(models.Model):
	...
	emp_qualification = CharField(max_length=25)
	emp_experience = models.CharField(max_length=25)
...
class Report(models.Model):
	fk_leave_id = models.IntegerField(max_length=25)
	fk_company_id = models.IntegerField(max_length=25)
	fk_task_id = models.IntegerField(max_length=25)
	fk_project_id = models.IntegerField(max_length=25)
	fk_vacancy_id = models.IntegerField(max_length=25)
	fk_performance_id = models.IntegerField(max_length=25)
	fk_intimation_id = models.IntegerField(max_length=25)



class HRregistration(models.Model):
	hr_first_name = models.CharField(max_length=20)
	hr_last_name = models.CharField(max_length=20)
	hr_address = models.CharField(max_length=50)
	hr-gender = models.CharField(max_length=25)
